...
#counts_directory = "/home/splaisie/scripts/temp/"
#counts_directory = "/data/CEM/wilsonlab/projects/GenomicsCURE/PlacentaSexDifferences/raw_feature_counts_rna/sccREF/"
#/data/CEM/wilsonlab/projects/GenomicsCURE/PlacentaSexDifferences/raw_feature_counts_rna/sccREF/OBG0044-1-010_HISAT_geneCounts_XX.txt
#/data/CEM/wilsonlab/projects/GenomicsCURE/PlacentaSexDifferences/raw_feature_counts_rna/sccREF/OBG0044-1-010_HISAT_transcriptCounts_XX.txt
...
for (dirpath, dirnames, filenames) in os.walk(counts_directory):
    geneCounts_files += [os.path.join(dirpath, file) for file in filenames if "geneCounts" in file and not "summary" in file and not "geneCounts_all.csv" in file]
    transcriptCounts_files += [os.path.join(dirpath, file) for file in filenames if "transcriptCounts" in file and not "summary" in file and not "transcriptCounts_all.csv" in file]
